...
BluetoothService <- QLowEnergyController: onControllerStateChanged(state)
Device <- BluetoothService: onDeviceConnected(remote, local)
Device -> Remote: create
BluetoothService <- QLowEnergyController: onControllerStateChanged(state)
Device <- BluetoothService: onDeviceDisconnected()
